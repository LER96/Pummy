...
namespace FIMSpace.Generating
{
    public static partial class FMeshUtils
    {
        ...
        internal static void OffsetUV(Mesh mesh, Vector2 uVOffset)
        {
            Vector2[] uvs = mesh.uv;
        ...
        internal static void RotateUV(Mesh mesh, float angle)
        {
            Vector2[] uvs = mesh.uv;
        ...
        internal static void RescaleUV(Mesh mesh, Vector2 uVReScale)
        {
            Vector2[] uvs = mesh.uv;
            for (int u = 0; u < uvs.Length; u++)
            {
        ...
        internal static void FlipNormals(Mesh mesh)
        {
