...
{
    public class SR_SpawningPropability : SpawnRuleBase, ISpawnProcedureType
    {
        public override string TitleName() { return "Spawning Propability"; }
        public override string Tooltip() { return "Percentage propability to allow/disallow spawning in checked cell\n[Lightweight]"; }
