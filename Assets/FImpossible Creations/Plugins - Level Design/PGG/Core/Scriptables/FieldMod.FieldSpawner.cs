    ...
    public partial class FieldSpawner
    {
        ...
        public void PreGenerating()
        {
            ...
            for (int r = 0; r < Rules.Count; r++)
            {
                var rl = Rules[r];
                if (rl == null) continue;
                if (rl.GetType() == typeof(Rules.QuickSolutions.SR_SubSpawner))
                {
                    Rules.QuickSolutions.SR_SubSpawner subSp = rl as Rules.QuickSolutions.SR_SubSpawner;
                    subSp.spawner.PreGenerating();
                }
            }
        }
        ...
        public void AfterGeneratingCall()
        {
            ...
            for (int r = 0; r < Rules.Count; r++)
            {
                ...
                {
                    Rules.QuickSolutions.SR_SubSpawner subSp = rl as Rules.QuickSolutions.SR_SubSpawner;
                    subSp.spawner.AfterGeneratingCall();
                }
            }
        }
