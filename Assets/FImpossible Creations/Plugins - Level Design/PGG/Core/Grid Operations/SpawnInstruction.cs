...
namespace FIMSpace.Generating
{
    ...
    public struct SpawnInstruction
    {
        ...
        { get { if (definition == null) return false; if (definition.InstructionType == InstructionDefinition.EInstruction.PreRunModificator || definition.InstructionType == InstructionDefinition.EInstruction.DoorHole) return true; return false; } }
