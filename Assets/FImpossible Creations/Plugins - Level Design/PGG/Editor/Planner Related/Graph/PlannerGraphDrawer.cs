...
using FIMSpace.Generating.Planning.PlannerNodes.Field.Operations;
...
namespace FIMSpace.Graph
{
    ...
    public class PlannerGraphDrawer : FGraphDrawerBase
    {
        ...
        public List<PGGPlanner_NodeBase> Nodes { get { if (DisplayMode == FieldPlanner.EViewGraph.Procedures_Placement) return currentSetup.Procedures; else return currentSetup.PostProcedures; } }
