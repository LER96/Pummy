...
namespace FIMSpace.Generating.Planning.PlannerNodes.Generating
{
    ...
    public class PR_GetScaleConvertedShape : PlannerRuleBase
    {
        ...
        public override Vector2 NodeSize { get { return new Vector2(198, 122); } }
        ...
        public override void OnStartReadingNode()
        {
            ...
            CheckerField3D convertedChecker = portChecker.GenerateCheckerConvertedToNewScale(myPlan.LatestChecker.RootScale);
