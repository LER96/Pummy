...
namespace FIMSpace.Generating.Planning
{
    ...
    public partial class FieldPlanner : ScriptableObject, IPlanNodesContainer
    {
        ...
        public void RunStartProcedures(PlanGenerationPrint gen)
        {
            ...
            {
                //UnityEngine.Debug.Log("[Planner] No 'Procedures Start' node!");
            ...
            {
                //UnityEngine.Debug.Log("[Planner] 'Procedures Start' node is not connected with any other node!");
                CompleteGenerating();
                return;
            }
        ...
        internal void OnCompleateAllGenerating()
        {
            if (!Discarded)
                if (LatestResult != null)
                    ...
                    {
                        LatestResult.CellsInstructions[c].HelperCellRef = LatestResult.Checker.GetCell(LatestResult.CellsInstructions[c].HelperCellRef.Pos);
                    }
