    ...
    public class ObjectStampEmitter : ObjectStampEmitterBase, IGenerating
    {
        ...
        private void Start()
        {
            ...
            if (SpawnOnStart)
            {
                if (RandomizeOnStart)
                {
                    spawningInfo = PrefabsSet.Emit(); // Random emission from set
                }
        ...
        {
            if (RandomizeOnStart || spawningInfo.ChoosedPrefab == null) spawningInfo = PrefabsSet.Emit(); // Random emission from set
            SpawnEmitPrefab();
        }
        ...
        {
            if (spawningInfo.ChoosedPrefab == null) spawningInfo = PrefabsSet.Emit();
            return spawningInfo;
        }
        ...
        public void _EditorEmitAndDetach()
        {
            ...
            if (emitted != null) emitted.transform.SetParent(transform.parent, true);
        }
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (spawningInfo.ChoosedPrefab == null) spawningInfo = PrefabsSet.Emit();
            else if (spawningInfo.SetReference != PrefabsSet) spawningInfo = PrefabsSet.Emit();
    ...
    public class ObjectsStampEmitterEditor : ObjectsStampEmitterBaseEditor
    {
        ...
        protected override void DrawProperties()
        {
            ...
            if (Get.PrefabsSet)
            {
                ...
                if (EditorGUI.EndChangeCheck()) Get.spawningInfo = Get.PrefabsSet.RefreshEmitInfo(Get.spawningInfo);
